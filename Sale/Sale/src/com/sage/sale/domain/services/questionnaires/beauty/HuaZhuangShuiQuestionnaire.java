...
public class HuaZhuangShuiQuestionnaire extends BaseQuestionnaire<HuaZhuangShuiProductRepository> {
	...
	protected void CalculateScore() {
		...
		switch (getAnswer(5)) {
		case 0: {
			getProduct(7).addValue(300 * 0.75 * 0 * ps, "抗衰老");
			getProduct(8).addValue(300 * 0.5 * 0 * ps, "抗衰老");
			getProduct(10).addValue(300 * 0.5 * 0 * ps, "抗衰老");
			break;
		}
		case 1: {
			getProduct(7).addValue(300 * 0.75 * 0.25 * ps, "抗衰老");
			getProduct(8).addValue(300 * 0.5 * 0.25 * ps, "抗衰老");
			getProduct(10).addValue(300 * 0.5 * 0.25 * ps, "抗衰老");
			break;
		}
		case 2: {
			getProduct(7).addValue(300 * 0.75 * 0.5 * ps, "抗衰老");
			getProduct(8).addValue(300 * 0.5 * 0.5 * ps, "抗衰老");
			getProduct(10).addValue(300 * 0.5 * 0.5 * ps, "抗衰老");
			break;
		}
		case 3: {
			getProduct(7).addValue(300 * 0.75 * 0.75 * ps, "抗衰老");
			getProduct(8).addValue(300 * 0.5 * 0.75 * ps, "抗衰老");
			getProduct(10).addValue(300 * 0.5 * 0.75 * ps, "抗衰老");
			break;
		}
		case 4: {
			getProduct(7).addValue(300 * 0.75 * 1 * ps, "抗衰老");
			getProduct(8).addValue(300 * 0.5 * 1 * ps, "抗衰老");
			getProduct(10).addValue(300 * 0.5 * 1 * ps, "抗衰老");
			break;
		}
		default:
			break;
